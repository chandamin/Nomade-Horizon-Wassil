      ...
      <div className="mx-auto max-w-[1366px] px-6 pt-8 pb-12">
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[1fr_400px]">
          <div className="min-w-0">
            <h1 className="mb-10 text-[52px] font-normal leading-none text-black">
              Thank you {firstName}!
            </h1>

            <p className="mb-8 text-[28px] leading-snug text-black">
              Your order number is <span className="font-medium">{orderId}</span>
            </p>

            <div className="max-w-[760px] space-y-8 text-[28px] leading-[1.45] text-black">
              <p>
            ...
            <div className="my-12 h-px w-full max-w-[820px] bg-[#d9d9d9]" />

            <button
              type="button"
              onClick={onContinueShopping}
              className="inline-flex items-center rounded-[10px] border border-[#d6d6d6] bg-white px-8 py-4 text-[28px] font-normal text-black shadow-sm transition hover:bg-[#fafafa]"
            >
              Continue Shopping »
            </button>
          </div>
          ...
          <aside className="self-start rounded-[14px] border border-[#d9d9d9] bg-white overflow-hidden">
            ...
            <div className="border-b border-[#e5e5e5] px-6 py-5">
              <div className="mb-5 text-[26px] text-black">
                  ...
                  <div key={`${item.id || item.product_id}-${index}`} className="flex gap-4">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-start justify-between gap-4">
                        <div className="min-w-0">
                          <div className="truncate text-[26px] leading-tight text-black">
                          ...
                          {item.options?.map((opt, i) => (
                            <div
                              key={`${opt.name}-${i}`}
                              className="text-[22px] leading-snug text-[#666]"
                            >
                              {opt.name} {opt.value}
                            </div>
                          ))}
            ...
            <div className="space-y-4 border-b border-[#e5e5e5] px-6 py-6 text-[28px] text-black">
            ...
            <div className="px-6 py-6">
              <div className="flex items-center justify-between text-[34px] font-medium text-black">
